...
namespace MyCustomShipping\Test\Controller\Adminhtml\Warehouse;
...
class Sync extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \MyCustomShipping\Test
        \Model\WarehouseFactory $warehouseFactory,
        \Magento\Framework\HTTP\ZendClientFactory $httpClientFactory,
        \Magento\Framework\Api\SearchCriteriaBuilder $searchCriteriaBuilder,
        \MyCustomShipping\Test\Api\CityRepositoryInterface $cityRepository,
    ...
    public function execute()
    {
        ...
        if (property_exists($warehouseApi, 'success') && $warehouseApi->success === true) {
            ...
            $this->_redirect('mycustomshipping/warehouse/index');
        } else {
    ...
    private function _syncWithDb($warehouseDataApi)
    {
        ...
        $tableName = $this->resourceConnection->getTableName('custom_novaposhta_warehouse');
        $tableCityName = $this->resourceConnection->getTableName('custom_novaposhta_city');
